...
function is_showing_post($anb_id) {
	...
	$check_post_type = (!empty($alert_notice_display_in) && !empty($page_post_type_name)) ? strpos($alert_notice_display_in, $page_post_type_name) : false;
...
function create_all_anb_css_parts() {
	create_anb_css_animations_stylesheet();
	create_anb_css_animations_out_stylesheet();
	create_anb_css_designs_stylesheet();
	create_anb_css_locations_stylesheet();
